            ...
            <div class="col-md-4 p-5">
                ...
                <div class="registration-area">
                    ...
                    <p class="registration-area">
                        There are many ways to customize pictures, but with this awesome site, you are able to do
                        magnificant edits on your most favourite pictures.
                    </p>
                </div>
                <div class="registration-area mt-5">
                    ...
                    <hr>
                    <p class="registration-area">
                        With just one click, you can upload your most favourite pictures and let everyone know where you
                        have been with our awesome map tools.
                    </p>
                </div>
            </div>
        </div>
    ...
    <div class="about-us">
        ...
        <div class="row">
            <div class="col-md-4">
                ...
                <p>
                    Nothing stops him from gaining as much knowledge as possible from every source. Undefeated in Halo
                    Reach. Founder of MilHochGrub GmbH.
                </p>
            </div>
            <div class="col-md-4">
                ...
                <p>
                    Even in his love/hate relationship with javascript and php, he is still eager enough to achieve
                    everything.
                </p>
            </div>
            <div class="col-md-4">
                ...
                <p>
                    Stefan is a specialist regarding Javascript/HTML/Bootstrap/JQuery/php. He works parttime for a
                    company and lives in vienna since one and a half year.
                </p>
            </div>
        </div>
    </div>
