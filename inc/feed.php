...
<div id="myImages">
    ...
    for ($i = 0; $i < sizeof($images); $i++) {
        echo "<div class=\"col-md-6 col-lg-3 my-image registration-area\">";
        echo "<img id=\"" . $images[$i]["pk_bild_id"] . "\" src=\"" . $images[$i]["thumbnail_directory"] . "\" class=\"img-fluid card-img-top\" alt=\"" . $images[$i]["name"] . "\">";
        $imageplace = $images[$i]["name"];
		$newimage = explode('.', $imageplace, -1);
		echo "<h6 class='text-center'> Name: " . $newimage[0] . "</h6>";
