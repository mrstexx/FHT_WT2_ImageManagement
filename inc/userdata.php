    ...
    <div class="user_data_banner">
        <div class="user_data">
            ...
            <form id="update_data" method="POST" action="">
                ...
                <button type="submit" value="continue" name="data_change" class="btn btn-secondary btn-block">Update
                    data
                </button>
            </form>
            ...
            <form id="update_password" method="POST" action="">
                ...
                <button type="submit" value="continue" name="password_change" class="btn btn-secondary btn-block">Update
                    password
                </button>
            </form>
